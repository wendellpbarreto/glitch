/*
Ultimate MMORPG Kit - WebScripts/ProfWeb - Client's script - skeletarik@gmail.com - 2013
This script is for updating character's profession and its level. It sends the information to the "prof.php" script.
*/
...
var formProf;					//Field for profession (including its level)

var URL = "http://www.warofdeath.com/MMORPG/prof.php"; 			//Change for your URL
...
function ProfWeb() {
    ...
    form.AddField( "myform_email", formEmail );
   	...
   	form.AddField( "myform_prof", formProf);
