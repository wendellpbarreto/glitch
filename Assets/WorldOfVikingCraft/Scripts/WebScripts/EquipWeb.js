/*
Ultimate MMORPG Kit - WebScripts/EquipWeb - Client's script - skeletarik@gmail.com - 2013
This script is for changing the character's equipment. It sends the information to the "equip.php" script.
*/
...
var formHand;				//Field for hand (right or left)
var formEq;					//Field for new weapon's name
...
function EquipWeb() {
    ...
    form.AddField( "myform_email", formEmail );
   	...
   	form.AddField( "myform_hand", formHand );
   	form.AddField( "myform_eq", formEq );
