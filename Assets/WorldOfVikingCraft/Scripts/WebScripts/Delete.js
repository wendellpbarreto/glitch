/*
Ultimate MMORPG Kit - WebScripts/Delete - Client's script - skeletarik@gmail.com - 2013
This script is for deleting the character. It sends the information to the "delete.php" script.
*/
...
var URL = "http://www.warofdeath.com/MMORPG/delete.php"; 	//Change for your URL
...
function Delete() {
    ...
    if (w.error != null) {
        ...
        formText = w.text; 									//Returning the data our PHP told us. It is useful for debug
       	GameObject.Find("Main Camera").GetComponent("ChooseCharacter").SendMessage("AnswerDelete", formText);
