/*
Ultimate MMORPG Kit - NetScripts/ThirdPersonControllerNET - Client's script - skeletarik@gmail.com - 2013
This script is for Player's controller.
*/
...
public class ThirdPersonControllerNET : MonoBehaviour
{
	...
	// Handle rotation here to ensure smooth application.
	{
		...
		if (Input.GetKeyDown(KeyCode.R) || Input.GetKeyDown(KeyCode.Plus))
		{
			walking = !walking;
		}
	}
